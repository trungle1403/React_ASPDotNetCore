...
namespace Cong.Class
{
    public static class OfficeConvert
    {
        ...
        //    return true;
        //}
        //public static bool DocxToPDF(string fileDocx)
        //{
        //    /*
        //    5 UnlockKeys
        ...
        /// </summary>
        /// <param name="path"></param>
        public static bool XlsxToPDF(string fileXlsx)
        {
            try
            {
        ...
        /// </summary>
        /// <param name="path"></param>
        public static string XlsxToHTML(string fileXlsx)
        {
            try
            {
                GemBox.Spreadsheet.SpreadsheetInfo.SetLicense("ETZX-IT28-33Q6-1HA2");
                ...
                return fileXlsx.Replace(".xlsx", ".html").Replace(".xls", ".html").Replace("~", "");
            }
            catch (Exception ex)
            {
                return "";
