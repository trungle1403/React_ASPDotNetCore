...
var NTS = {
    ...
    loadDataCombo: function (options) {
        ...
        var elements;
        if (!$.isEmptyObject(data.d) && data.d.length != 0)
            elements = $.map(data.d, function (e) {
                return [$.map(e, function (v) {
                    return v;
                })];
                ...
                for (i = 0; i < elements.length; i++) {
                    if (elements[i][settings.indexValue].toString() != "")
                        newDataSource.push({
                            ...
                            "disabled": (data.d[i]['disabled'] == "1" ? true : false)
                        });
                }
            } catch (e) {
    ...
    KiemTraQuyenXoa: function () {
      ...
      CauThongBaoXoa: function () {
          return "<p>Bạn có thật sự muốn xóa dòng dữ liệu đã chọn không?</p><p> - Đồng ý xóa chọn <b>'Chấp nhận'</b></p><p>- Không đồng ý chọn <b>'Hủy bỏ'</b></p>";
    },
    CauThongBaoDuyet: function () {
        return "Bạn có đồng ý xét duyệt thông tin đã chọn không?<br/> - Đồng ý chọn <b>'Chấp nhận'</b><br/>- Không đồng ý chọn <b>'Hủy bỏ'</b>.";
    },
    CauThongBaoBoDuyet: function () {
        return "<p>Bạn có đồng ý bỏ duyệt thông tin đã chọn không?<br/> - Đồng ý chọn <b>'Chấp nhận'</b>- Không đồng ý chọn <b>'Hủy bỏ'</b>.";
    },
    CauThongBaoGui: function () {
        return "<p>Khi thực hiện thao tác gửi, số liệu sẽ không được phép chỉnh sửa và đơn vị tiếp nhận sẽ nhận được số liệu bạn gửi. Bạn có muốn tiếp tục thực hiện thao tác không? Nếu đồng ý bấm vào <b>'Chập nhận'</b> không đồng ý bấm vào <b>'Hủy bỏ'</b></p>";
    },
    CauThongBaoBoGui: function () {
        return "<p>Khi thực hiện thao tác bỏ gửi, số liệu sẽ được phép chỉnh sửa và đơn vị tiếp nhận sẽ không nhận được số liệu bạn gửi. Bạn có muốn tiếp tục thực hiện thao tác không? Nếu đồng ý bấm vào <b>'Chập nhận'</b> không đồng ý bấm vào <b>'Hủy bỏ'</b></p>";
    },
    CauThongBaoPhucHoi: function () {
        return "<p>Bạn có đồng ý phục hồi thông tin đã chọn không?<br/> - Đồng ý chọn <b>'Chấp nhận'</b><br/>- Không đồng ý chọn <b>'Hủy bỏ'</b>.";
    },
}
